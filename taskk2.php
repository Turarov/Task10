<?php
    $dbhost = 'localhost';
         $dbuser = 'root';
         $dbpass = '';
         $conn = mysqli_connect($dbhost, $dbuser, $dbpass, 'mydatabase');
  ...
  <body>
  <div class="menu">
   <a href="index2.php?All">All</a>|<a href="index2.php?maker=Toyota">Toyota</a>|<a href="index2.php?maker=BMW">BMW</a></div>
   <div>
       <h1></h1>
   </div>
       <div class="cars">
